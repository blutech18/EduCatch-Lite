    ...
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4">
      ...
      <div className="relative z-10 text-center">
        ...
        <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          <Link
            href="/register"
            className="inline-flex items-center gap-2 rounded-xl bg-linear-to-r from-violet-600 to-indigo-600 px-8 py-3.5 text-sm font-semibold text-white shadow-xl shadow-violet-500/25 transition-all duration-200 hover:shadow-violet-500/40 hover:from-violet-500 hover:to-indigo-500"
          >
            Get Started Free
            <svg
              className="h-4 w-4"
        ...
        <div className="mt-20 grid grid-cols-1 gap-6 sm:grid-cols-3">
          {[
            ...
            <div
              key={feature.title}
              className="rounded-2xl border border-white/6 bg-slate-800/30 p-6 text-center transition-all duration-300 hover:border-white/12 hover:bg-slate-800/50"
            >
              {feature.icon}
